...
function drawPieChart(data) {
    ...
    _graphics.setFontSize(textSize);
    _graphics.setTextBaseline("middle");

    _graphics.setFillBrush("#444");
    _graphics.drawText(350, y + 13, currentLabel + ": " + currentValue);

    _graphics.setStrokeBrush(null);
    _graphics.setFillBrush("white");
    _graphics.drawCircle(300, 0, 260);

    _graphics.setFillBrush("#666");
    ...
    for (var i = 0; i < data.dataset.length; i++) {
        ...
        _graphics.setStrokeBrush("white");
